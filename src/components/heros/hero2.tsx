...
const Hero47 = ({
  oneWordHeading = 'Luxury ',
  heading = 'Car Services',
  subheading = 'At Your Doorstep',
  description = 'Experience premium car care without leaving your home. Our mobile app is coming soon!',
  buttons = {
    primary: {
      text: 'Get Notified!',
      url: '#',
  ...
  return (
    <section className="min-h-screen flex items-center justify-center pt-32 pb-20 px-4 bg-gradient-to-b from-[#112A12] to-[#1A3E1C]">
      <div className="container flex flex-col items-center gap-10 lg:my-0 lg:flex-row">
        <div className="flex flex-col gap-7 lg:w-2/3">
          <h2 className="text-5xl font-semibold md:text-5xl lg:text-8xl">
            <span className="text-accent">{oneWordHeading}</span>
            <span>{heading}</span>
            <br />
          ...
          <div className="flex flex-wrap items-start gap-5 lg:gap-7">
            <Button asChild className="bg-accent rounded-lg py-6">
